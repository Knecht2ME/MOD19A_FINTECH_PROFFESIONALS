...
def generate_account():
   ...
   # mnemonic = os.getenv("MNEMONIC")-- did not work had to hard code
    mnemonic = "test disease arrive toilet mule only matter stock skill gentle curve hire"
...
def send_transaction(w3, account, to, wage):
    ...
    result = w3.eth.sendRawTransaction(raw_transaction)
    return result
